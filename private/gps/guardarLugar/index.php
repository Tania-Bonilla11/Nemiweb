...
<head>
	...
	<title>Agregar zona verde | Nemi</title>
        ...
        <div class="containerr">
            ...
            <form role="form" action="guardar.php" method='post' enctype="multipart/form-data" class=formm>
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" required value="" name="nombre" size="25" />
                </div>
                <div class="form-group">
                    <label>Describa el lugar.</label>
                    <input class="form-control" type="text" required name="descripcion" value="" size="25" />
                </div>
                <div class="form-group">
                    <label>Ingrese el teléfono</label>
                    <input class="form-control" type="text" required name="telefono" value="" size="25" />
